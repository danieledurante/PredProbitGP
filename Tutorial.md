...
Leveraging the above function, we can **simulate the GP realizations at both training and test locations**, and the **transform theses values into the probabilities using the probit link**, as described in Section 3 of the article.
