...
```{r install tlrmvnratio package, echo = F, message = FALSE, warning = F}
...
endTime <- Sys.time()
timeCost <- as.numeric(difftime(endTime, startTime, "secs")) / 2
...
startTime <- Sys.time()
parmsSTAN <- list(N = nsub, Y = ysub, mu = mu, Omega = covM)
